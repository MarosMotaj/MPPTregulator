...
const char *topic_volts = "esp32/mptt-volts";
const char *topic_current = "esp32/mptt-amper";
const char *topic_power = "esp32/mptt-power";
const char *mqtt_username = "";
const char *mqtt_password = "";
const int mqtt_port = 1883;

// WiFi AP SSID
#define WIFI_SSID "Bru..."
// WiFi password
#define WIFI_PASSWORD "MEN..."
// InfluxDB v2 server url, e.g. https://eu-central-1-1.aws.cloud2.influxdata.com (Use: InfluxDB UI -> Load Data -> Client Libraries)
#define INFLUXDB_URL "http://192.168...:8086"
// InfluxDB v2 server or cloud API token (Use: InfluxDB UI -> Data -> API Tokens -> <select token>)
#define INFLUXDB_TOKEN "Jic4ga1e............................................TGg=="
